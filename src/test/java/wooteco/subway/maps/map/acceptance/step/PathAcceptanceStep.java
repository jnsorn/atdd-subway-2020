...
public class PathAcceptanceStep {
    ...
    public static ExtractableResponse<Response> 거리_경로_조회_요청_청소년(TokenResponse tokenResponse, String type, long source, long target) {
        return RestAssured.given().log().all().
    ...
    public static void 경로의_총_요금을_응답함(ExtractableResponse<Response> response, int fare) {
        PathResponse pathResponse = response.as(PathResponse.class);
